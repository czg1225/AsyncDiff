...
def run_inference(rank, world_size, config):
    ...
    if config["strategy"] == "n3s2":
        from animatediff.n3s2 import AsyncDiffusionWorker
    elif config["strategy"] == "n2s1":
        from animatediff.n2s1 import AsyncDiffusionWorker
    elif config["strategy"] == "n3s1":
        from animatediff.n3s1 import AsyncDiffusionWorker
    elif config["strategy"]== "n2s2":
        from animatediff.n2s2 import AsyncDiffusionWorker
